...
export const Pagination = ({displayPage, setDisplayPage, maxPage}: IPagination) => {
  ...
  return (
    <div className='flex items-center'>
          ...
          {/* <div className={`h-[40px] w-[100px] border-t-2 border-b-2 flex justify-center items-center `}>
            {`${displayPage}/${maxPage}`}
          </div> */}
          ...
          {/* <div className="h-[40px] w-[40px] flex justify-center items-center">
            {displayPage < 4 ? 2 : displayPage - 1 > 7 ? maxPage - 3: displayPage - 1}
          </div>
          <div className="h-[40px] w-[40px] flex justify-center items-center">
            {displayPage < 4 ? 4 : displayPage - 1 > 7 ? maxPage - 2: displayPage}
          </div>
          <div className="h-[40px] w-[40px] flex justify-center items-center">
            {displayPage < 4 ? 3 : displayPage - 1 > 7 ? maxPage - 1: displayPage + 1}
          </div> */}
